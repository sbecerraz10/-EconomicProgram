...

{
    ...
    private RedBlackNode<K> current;

    private RedBlackNode<K> parent;

    private RedBlackNode<K> grand;

    private RedBlackNode<K> great;

    private RedBlackNode<K> header;    
